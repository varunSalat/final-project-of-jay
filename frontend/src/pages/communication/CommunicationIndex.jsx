...
const CommunicationIndex = () => {
  ...
  return (
    ...
    >
      ...
      >
        {(isNonMobileScreens || !communication) && (
        ...
        {(communication || isNonMobileScreens) && (
          <WidgetWrapper style={{ flex: "1 50%", height: "100%" }}>
            {communication ? (
              ...
              >
                ...
                <Typography variant="h5">Shivam Messenger</Typography>
                <Typography color="text.secondary">
                  Privately message other users on Shivam
                </Typography>
              </Box>
            )}
          </WidgetWrapper>
